  ...
  return (
    <div className="about-component">
      ...
      <p>
        ...
        technology is used to issue, manage and verify academic certificates in
        a secure and distributed manner. This project addresses the need for a
        secure digital platform to issue and verify academic certificates
        without intervention from the original certificate issuer (University).
      </p>
      ...
      <ul>
        <li>
          Universities: issue academic certificates, view academic certificates
          issued, endorse verification and digitally sign academic certificates.
        </li>
        <li>
          ...
          with third party verifiers, selective disclosure of certificate data.
        </li>
        <li>
      ...
      <p>Features:</p>
      <ul>
        <li>A distributed and automated system for background verification.</li>
        <li>Data immutability is one of the main features of blockchain.</li>
        <li>
          It serves as a large public ledger where node in network verifies and
          save the same data.
        </li>
        <li>
        ...
        <li>The system helps in eradicating problems of fake certificates.</li>
      </ul>
    </div>
  );
}
